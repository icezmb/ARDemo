...
import com.amg.ar.mechanics.informations.score.ScoreInformation;
...
public class GameInformationStandard extends GameInformation {
    ...
    public GameInformationStandard(GameMode gameMode, Weapon weapon) {
        ...
        mWeapon = weapon;
        mCurrentTarget = null;
        mTargetableItems = new ArrayList<>();
    ...
    public TargetableItem getTargetableItem(int x,int y){
        for(TargetableItem item:mTargetableItems){
            if(item.isTarget(x,y)){
                return item;
            }
        }
        return null;
    ...
    public List<DisplayableItem> getItemsForDisplay() {
        final ArrayList<DisplayableItem> displayAll = new ArrayList<>();
