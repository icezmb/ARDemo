...
import com.amg.ar.ui.CameraPreview;

public abstract class ARBaseActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Beta-Only
        final SharedPreferences betaSharedPreferences =
                getSharedPreferences("BetaKeySharedPreferences", Context.MODE_PRIVATE);
        //mSensorDelay=Sensor.TYPE_MAGNETIC_FIELD;
        final boolean isCompatibilityModeActivated =
                betaSharedPreferences.getBoolean("BetaKeyCompatibilityModeActivated", false);
    ...
    protected void onResume() {
        ...
        if (mRotationVectorSensor != null) {
            mSensorManager.registerListener(ARBaseActivity.this, mRotationVectorSensor, mSensorDelay);
        } else {
            mSensorManager.registerListener(ARBaseActivity.this, mAccelerationSensor, mSensorDelay);//加速度传感器
            mSensorManager.registerListener(ARBaseActivity.this, mMagneticSensor, mSensorDelay);//磁场传感器
            mSensorManager.registerListener(ARBaseActivity.this, mGyroscopeSensor, mSensorDelay);//回转仪传感器
        }
    ...
    private final class CameraAsyncTask extends AsyncTask<Void, Void, Camera> {
        ...
        protected void onPostExecute(Camera result) {
            ...
            if (mCamera == null) {
                ...
                //第一层：相机视图层
                mCameraPreview = new CameraPreview(ARBaseActivity.this, mCamera);
